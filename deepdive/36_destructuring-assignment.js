...
// 디스트럭처링 할당(destructuring assignment)(구조 분해 할당)은 구조화된 배열과 같은 이터러블 또는 객체를
...
// ❕ 즉, 순서는 의미가 없으며 선언된 변수 이름과 프로퍼티 키가 일치하면 할당된다.
{
    ...
    // ES6 객체 디스트럭처링 할당
    // 변수 firstName, lastName을 선언하고 user 객체를 디스트럭처링하여 할당한다.
...
// 객체 디스트럭처링 할당을 위한 변수에 Rest 파라미터나 Rest 요소와 유사하게 Rest 프로퍼티 ...를 사용할 수 잇다.
...
// Rest 프로퍼티는 스프레드 프로퍼티와 함ㅁ께 2021년 1월 TC39 프로세스의 stage 4 단계에 제안되어 있다.
