...
// onprogress             | HTTP 요청에 대한 응답을 받느 도중 주기적으로 발생
// onabort                | abort 메서드에 의해 HTTP 요청이 중단된 경우
// onerror 중요            | HTTP 요청에 에러가 발생한 경우
// onload 중요             | HTTP 요청이 성공적으로 완료한 경우
...
// open 중요             | HTTP 요청 초기화
// send 중요             | HTTP 요청 전송
// abort 중요            | 이미 전송된 HTTP 요청 중단
// setRequestHeader 중요 | 특정 HTTP 요청 헤더의 값을 설정
